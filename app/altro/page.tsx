          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <div className="space-y-2 text-[12px] text-white/50">
                <div><span className="font-[family-name:var(--font-jetbrains)] text-white/30">v1.2.0</span> — Dettaglio punteggi live dei giocatori nella classifica weekend, mercato bloccato durante sessioni, fix auth OpenF1 e classifica per lega</div>
